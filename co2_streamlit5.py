...
st.sidebar.markdown(
    ...
    <p class="css-vk3wp9 css-promotion"><span class="css-promotion-text">Promotion Continue DA - Octobre 2022</span><a href="https://datascientest.com/" target="_blank"><img src="https://datascientest.com/en/wp-content/uploads/sites/9/2020/08/new-logo.png" alt="Datascientest" class="datascientest-logo" /></a></p>
    """,
    unsafe_allow_html=True,
)
...
def predictions ():
    ...
    image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\matrice correlation variables")
    st.image(image)
    ...
    image = Image.open (r"C:\Users\jt_ur\DA\projects\streamlit uploadé\courbe erreur arima 110 erreur 0.0128")
    st.image(image)
    ...
    image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\perf modele co2 20 dernières années")
    st.image(image)
    ...
    image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\perf modele temperatures sur les 20 dernières années")
    st.image(image)
    ...
    if (machine_learning_model=='forets aléatoires') and (year_prediction=='2100'):
        ...
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prevision foret 2100")
        st.image(image)

    elif (machine_learning_model=='forets aléatoires') and (year_prediction=='2500'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prediction 2500 foret")
        st.image(image)
        
    elif (machine_learning_model=='forets aléatoires') and (year_prediction=='3000'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prediction foret 3000")
        st.image(image)
        
    elif (machine_learning_model=='régression linéaire par point géographique') and (year_prediction=='2100'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte regression lineaire 2100")
        st.image(image)
        
    elif (machine_learning_model=='régression linéaire par point géographique') and (year_prediction=='2500'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte linearbypoint prediction 2500")
        st.image(image)
        
    elif (machine_learning_model=='régression linéaire par point géographique') and (year_prediction=='3000'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prediction lineaire 3000")
        st.image(image)
        
    elif (machine_learning_model=='régression polynomiale par point géographique') and (year_prediction=='2100'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prediction poly 2100")
        st.image(image)
        
    elif (machine_learning_model=='régression polynomiale par point géographique') and (year_prediction=='2500'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prediction poly 2500")
        st.image(image)
        
    elif (machine_learning_model=='régression polynomiale par point géographique') and (year_prediction=='3000'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prevision poly 3000")
        st.image(image)
        
    elif (machine_learning_model=='régression linéaire générale') and (year_prediction=='2100'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prevision linear gene2100")
        st.image(image)
        
    elif (machine_learning_model=='régression linéaire générale') and (year_prediction=='2500'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prevision linear gene 2500")
        st.image(image)
        
    elif (machine_learning_model=='régression linéaire générale') and (year_prediction=='3000'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prevision linear gene 3000")
        st.image(image)
        
    elif (machine_learning_model=='régression polynomiale générale') and (year_prediction=='2100'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prediciotn poly gene2100")
        st.image(image)
        
    elif (machine_learning_model=='régression polynomiale générale') and (year_prediction=='2500'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prediction temperature poly gene2500")
        st.image(image)
        
    elif (machine_learning_model=='régression polynomiale générale') and (year_prediction=='3000'):
        
        image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\carte prediction 3000 poly gene")
        st.image(image)
    ...
    image = Image.open(r"C:\Users\jt_ur\DA\projects\streamlit uploadé\arima_momo.png")
    st.image(image)
